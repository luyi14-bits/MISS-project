...
> 更新时间：2026-07-02 · 当前发布版本：Alpha v0.4
...
|------|---------|------|
| ✅ **已完成** | 10 | 已发布/验收通过 |
| 📝 **规划中** | 2 | SillyTavern 角色卡兼容 + v0.5-alpha |
...
| 项目 | 内容 | 优先级 |
|------|------|--------|
| SillyTavern Character Card 兼容 | PNG 嵌入角色定义，导入/导出 | P3 |
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2026-07-02 | Alpha v0.4 | 角色隔离 ✅ / pm-mentor Skill 🆕 / 标准文件补齐 / 项目总结 |
