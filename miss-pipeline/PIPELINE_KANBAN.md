...
|------|---------|------|
| ✅ **已完成** | 13 | 已发布/验收通过 |
| 🔨 **开发中（规划）** | 3 | 多人角色房间(P1) + 角色进阶(P2) + 插件预留(P3) |
| 💡 **想法池** | 3 | 多语言UI · WebUI · 移动端 |
...
| Spec | 内容 | 优先级 | 估时 |
|------|------|:------:|:----:|
| multi-character-room | 多人角色房间 — 广播模型 + 上下文感知 + 多面板 UI | P1 | 4d |
| character-progression | 角色进阶系统 — 属性渐变 + 完成度可视化 | P2 | 3d |
| plugin-sidecar | 插件 sidecar 接口预留 | P3 | 0.5d |
